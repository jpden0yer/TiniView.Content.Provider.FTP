    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT) {
            ...
            public void onSwiped(RecyclerView.ViewHolder viewHolder, int swipeDir) {
                ...
                //   cdeuri = uri.buildUpon().appendPath(stringId).build();


                ContentValues contentValues = new ContentValues();
                // Put the task description and selected mPriority into the ContentValues
                contentValues.put(TaskContract.TaskEntry.COLUMN_TEXTDATA, "");

                String whereclause = TaskContract.TaskEntry._ID + "="  +  id;
                getContentResolver().update(TaskContract.TaskEntry.CONTENT_URI, contentValues, whereclause, null);
